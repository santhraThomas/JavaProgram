                    ...
                    while (valid):
                        ...
                        try:
                            if (betMoney >= 1 and betMoney <= 5):
                                dollar -= betMoney
                                bet_choice = input("Press 'P' to bet on PASS line or press 'D' to bet on DON'T PASS line or press 'R' for the roller: ")
                                if bet_choice.lower() == 'p' or bet_choice.lower() == 'd':
                                    choice = input("Press any key to roll the dice: ")
                                    die1 = random.randrange(1,7)
                                    die2 = random.randrange(1,7)
                                    totSumDice = die1 + die2
                                    print("Result of dices: ", "(",die1,",", die2, ")", "=",  totSumDice)
                                    if bet_choice.lower() == 'p':
                                        ...
                                        if (betValue == 1 and totSumDice == 4)or(betValue == 2 and totSumDice == 5)or(betValue == 3 and totSumDice == 6)or(betValue == 4 and totSumDice == 8)or(betValue == 5 and totSumDice == 9) or(betValue == 6 and totSumDice == 10):
                                            ...
                                            p_dollar -= betMoney
                                            print("Your remaining money: ", p_dollar)
                                        if (totSumDice == 7 or totSumDice == 11):
                                            print("The roller won in first roll!!")
                                            valid = False

                                        elif(totSumDice == 2 or totSumDice == 3 or totSumDice == 12):
                                            print("The roller lost in first roll!!")
                                            valid = False
                                        else:
                                            point = totSumDice
                                                                ...
                                                                if (betValue < 1 or betValue > 10):
                                                                    ...
                                                                    while(sideBetChoice):
                                                                        ...
                                                                        if (sideBet < 1 or sideBet > 5):
                                                                            ...
                                                                            p_dollar = p_dollar - sideBet
                                                                            if(p_dollar < 0):
                                                                                print("Insufficient amount for betting! Remaining money: ", p_dollar)
                                                                                sys.exit()
                                                                            else:
                                                                                if totSumDice == 7:
                                                                                    ...
                                                                                    p_dollar - sideBet
                                                                                    sideBet = 0
                                                                                    print("Remaining dollars : ", p_dollar)
                                        ...
                                        if (betValue == 1 and totSumDice != 4)or(betValue == 2 and totSumDice != 5)or(betValue == 3 and totSumDice != 6)or(betValue == 4 and totSumDice != 8)or(betValue == 5 and totSumDice != 9) or(betValue == 6 and totSumDice != 10):
                                            ...
                                            d_dollar = d_dollar + (2*betMoney)
                                        elif (betValue == 7 and totSumDice == 4 and die1 != die2):
                                            print("You won the Don't PASS Line Side Bet for doubles!!")
                                            d_dollar = d_dollar + (7*betMoney)
                                        elif (betValue == 8 and totSumDice == 6 and die1 != die2):
                                            print("You won the Don't PASS Line Side Bet for doubles!!")
                                            d_dollar = d_dollar + (7*betMoney)
                                        elif (betValue == 9 and totSumDice == 8 and die1 != die2):
                                            print("You won the Don't PASS Line Side Bet for doubles!!")
                                            d_dollar = d_dollar + (9*betMoney)
                                        elif (betValue == 10 and totSumDice == 10 and die1 != die2):
                                            print("You won the Don't PASS Line Side Bet for doubles!!")
                                            d_dollar = d_dollar + (9*betMoney)
                                        else:
                                            print("You lose the bet and lost your money")
                                            d_dollar -= betMoney
                                            print("Your remaining money: ", d_dollar)
                                        if (totSumDice == 7 or totSumDice == 11):
                                            print("The roller won in first roll!!")
                                            valid = False
                                                                ...
                                                                if (betValue < 1 or betValue > 10):
                                                                    ...
                                                                    while(sideBetChoice):
                                                                        ...
                                                                        if (sideBet < 1 or sideBet > 5):
                                                                            ...
                                                                            d_dollar = d_dollar - sideBet
                                                                            if(d_dollar < 0):
                                                                                print("Insufficient amount for betting! Remaining money: ", d_dollar)
                                                                                sys.exit()
                                                                            else:
                                                                                if totSumDice == 7:
                                                                                    print("You lost all your side bets")
                                                                                    d_dollar - sideBet
                                                                                    sideBet = 0
                                                                                    print("Remaining dollars : ", d_dollar)
                                                                                elif totSumDice == 4 or totSumDice == 5 or totSumDice == 6 or totSumDice == 8 or totSumDice == 9 or totSumDice == 10:
                                                                                    if (betValue == 1 and totSumDice == 4)or(betValue == 2 and totSumDice == 5)or(betValue == 3 and totSumDice == 6)or(betValue == 4 and totSumDice == 8)or(betValue == 5 and totSumDice == 9) or(betValue == 6 and totSumDice == 10):
                                                                                        print("You won the PASS Line Side Bet!!")
                                                                                        d_dollar = d_dollar + (2*betMoney)
                                                            ...
                                                            if (betValue < 1 or betValue > 10):
                                                                ...
                                                                while(sideBetChoice):
                                                                    ...
                                                                    if (sideBet < 1 or sideBet > 5):
                                                                        ...
                                                                        if(dollar < 0):
                                                                            print("Insufficient amount for betting! Remaining money: ", dollar)
                                                                            sys.exit()
                                                                        else:
                                                                            if totSumDice == 7:
                                                                                print("You lost all your side bets")
