...
with open("hw4.txt", 'r') as fields:
    ...
    for line in fields:
        ...
        while counter < numLines:
            sumHome += int(homeScore) #stores the sum of WSU scores
            sumAway += int(awayScore) #stores the sum of other scores
            if homeScore > awayScore:
                ...
                lossScore = int(homeScore) - int(awayScore)
                diffLoss += lossScore
    ...
    avgWin = diffWin/homeWin
    avgLoss= diffLoss/homeLoss
    ...
    print("Average winning margin: "+ str(round(avgWin,2)), ", Average losing margin: "+ str(round(avgLoss,2)))
